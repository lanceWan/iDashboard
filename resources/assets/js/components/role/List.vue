...
<div>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2><i class="fa fa-diamond"></i> 角色管理</h2>
            <ol class="breadcrumb">
                <li>
                	<router-link to="/dash">
        ...
        <div class="col-lg-2">
			    <div class="title-action">
			    	<router-link :to="{name:'create-role'}" tag="div">
			    		<a class="btn btn-info"><i class="fa fa-plus"></i> 添加角色</a>
			    	</router-link>
			    </div>
			  </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><i class="fa fa-paper-plane-o"></i>  角色列表</h5>
                    </div>
