        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/permission')}}" class="form-horizontal">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" placeholder="{{trans('admin/permission.model.name')}}"> 
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="slug" placeholder="{{trans('admin/permission.model.slug')}}"> 
                @if ($errors->has('slug'))
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="description" placeholder="{{trans('admin/permission.model.description')}}">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="model" placeholder="{{trans('admin/permission.model.model')}}">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
